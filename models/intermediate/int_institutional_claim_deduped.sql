...
, claim_line_total as (
    ...
    select 
          cur_clm_uniq_id
        , sum(cast(clm_line_cvrd_pd_amt as {{dbt.type_numeric()}}))  as sum_clm_line_cvrd_pd_amt
    from remove_dupes 
...
, mapping as (
    ...
    select
        ...
        , concat(clm_bill_fac_type_cd,clm_bill_clsfctn_cd,clm_bill_freq_cd) as bill_type_code
        , case
