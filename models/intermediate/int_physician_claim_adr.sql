...
/* 
    Fixing clm_cntl_num values where leading zero was dropped from a subset of claims.
*/
, fix_clm_cntl_num as (
    ...
    select
        ...
        , clm_efctv_dt
        , CASE
            WHEN LEN(clm_cntl_num) < 15 THEN RIGHT('000000000000000' + clm_cntl_num, 15)
            ELSE clm_cntl_num
        END as clm_cntl_num
        , clm_line_alowd_chrg_amt
        , clm_line_srvc_unit_qty
