...
, mapping as (
    ...
    select
        ...
        , nullif(hcpcs_1_mdfr_cd,'~') as hcpcs_modifier_1
        , nullif(hcpcs_2_mdfr_cd,'~') as hcpcs_modifier_2
        , nullif(hcpcs_3_mdfr_cd,'~') as hcpcs_modifier_3
        , nullif(hcpcs_4_mdfr_cd,'~') as hcpcs_modifier_4
        , nullif(hcpcs_5_mdfr_cd,'~') as hcpcs_modifier_5
        ...
        , nullif(clm_dgns_1_cd,'~') as diagnosis_code_1
        , nullif(clm_dgns_2_cd,'~') as diagnosis_code_2
        , nullif(clm_dgns_3_cd,'~') as diagnosis_code_3
        , nullif(clm_dgns_4_cd,'~') as diagnosis_code_4
        , nullif(clm_dgns_5_cd,'~') as diagnosis_code_5
        , nullif(clm_dgns_6_cd,'~') as diagnosis_code_6
        , nullif(clm_dgns_7_cd,'~') as diagnosis_code_7
        , nullif(clm_dgns_8_cd,'~') as diagnosis_code_8
        , nullif(clm_dgns_9_cd,'~') as diagnosis_code_9
        , nullif(clm_dgns_10_cd,'~') as diagnosis_code_10
        , nullif(clm_dgns_11_cd,'~') as diagnosis_code_11
        , nullif(clm_dgns_12_cd,'~') as diagnosis_code_12
